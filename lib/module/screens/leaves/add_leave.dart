            ...
            children: [
              ...
              InkWell(
                ...
                child: DatePickerContainer(
                    date: stopDate == null
                        ? 'Pick Your date'
                        : '${stopDate!.day}-${stopDate!.month}-${stopDate!.year}'),
              ),
                    ...
                    Expanded(
                      child: SecondaryButton(
                        ...
                        onTap: (startLoading, stopLoading, btnState) async {
                          startLoading();
                          final leave = await si.leaveService.addLeave(context,
                              title: title.text,
                              startDate: startDate!,
                              stopDate: stopDate!);
                          if (leave!.resourceId == 0 && leave.leaveId == 0) {
                            stopLoading();
                          } else {
                            setState(() {
                              si.dialogService.successSnackBar(context, 'Leave added successfully', false);
                              title.clear();
                              startDate = null;
                              stopDate = null;
                            });
